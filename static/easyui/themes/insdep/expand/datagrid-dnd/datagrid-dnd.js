			...
			return jq.each(function(){
				...
				var draggableOptions = {
					...
					proxy: function(source) {
						var p = $('<div style="z-datams:9999999999999"></div>').appendTo('body');
					...
					onDrag: function(e) {
						...
						if (d>3){	// when drag a little distance, show the proxy object
							...
							var tr = opts.finder.getTr(target, parseInt($(this).attr('datagrid-row-datams')), 'body');
							$.extend(e.data, {
				...
				var droppableOptions = {
					...
					onDragOver: function(e, source) {
						...
						if (tr.length){
							...
							$(dTarget).datagrid('clearInsertingFlag');
							dOpts.insertingIndex = tr.attr('datagrid-row-datams');
					...
					onDrop: function(e, source) {
						...
						function insert(){
							var destIndex = parseInt(tr.attr('datagrid-row-datams'));
