var defaultView = {
	render: function(target, container, frozen){
		...
		for(var i=0; i<rows.length; i++) {
			...
			table.push('<tr id="' + rowId + '" datagrid-row-datams="' + i + '" ' + cls + ' ' + style + '>');
	...
	renderFooter: function(target, container, frozen){
		...
		for(var i=0; i<rows.length; i++){
			table.push('<tr class="datagrid-row" datagrid-row-datams="' + i + '">');
			table.push(this.renderRow.call(this, target, fields, frozen, i, rows[i]));
			table.push('</tr>');
		}
	...
	insertRow: function(target, index, row){
		...
		function _insert(frozen){
			...
			var tr = '<tr id="' + rowId + '" class="datagrid-row" datagrid-row-datams="' + index + '"></tr>';
//				var tr = '<tr id="' + rowId + '" class="datagrid-row" datagrid-row-datams="' + datams + '">' + this.renderRow.call(this, target, fields, frozen, datams, row) + '</tr>';
