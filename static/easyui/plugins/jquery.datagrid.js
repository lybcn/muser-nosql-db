...
function _9b(tr){
if(tr.attr("datagrid-row-datams")){
return parseInt(tr.attr("datagrid-row-datams"));
}else{
...
for(var i=0;i<rows.length;i++){
_215.push("<tr class=\"datagrid-row\" datagrid-row-datams=\""+i+"\">");
...
_21b.push("<tr id=\""+_21d+"\" datagrid-row-datams=\""+_217+"\" "+cls+" "+_21c+">");
...
tr.attr("datagrid-row-datams",i+1);
...
var tr="<tr id=\""+_241+"\" class=\"datagrid-row\" datagrid-row-datams=\""+_237+"\"></tr>";
if(_237>=data.rows.length){
if(data.rows.length){
...
tr.removeClass("datagrid-row").removeAttr("datagrid-row-datams");
...
if(!tr.length){
tr=(_25a==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-datams="+_259+"]");
}
return tr;
}else{
if(type=="footer"){
return (_25a==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-datams="+_259+"]");
}else{
if(type=="selected"){
...
if(type=="last"){
return (_25a==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-datams]:last");
}else{
if(type=="allbody"){
return (_25a==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-datams]");
}else{
if(type=="allfooter"){
return (_25a==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-datams]");
}
}
}
}
...
var _25d=(typeof p=="object")?p.attr("datagrid-row-datams"):p;
