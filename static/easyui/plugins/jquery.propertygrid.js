...
var _11=parseInt($(this).attr("datagrid-row-datams"));
...
var _25=[];
_25.push("<div class=\"datagrid-group\" group-datams="+_1f+">");
...
_25.push("<tr id=\""+_2a+"\" datagrid-row-datams=\""+_26+"\" "+cls+" "+_29+">");
...
if(_2f.length){
var _30=_2f.closest("div.datagrid-group").attr("group-datams");
...
var _40=_3f.find(_3e!=undefined?"div.datagrid-group[group-datams=\""+_3e+"\"]":"div.datagrid-group");
...
var _44=_43.find(_42!=undefined?"div.datagrid-group[group-datams=\""+_42+"\"]":"div.datagrid-group");
...
var _4b=dc.body2.children("div.datagrid-group[group-datams="+_47+"]").find("span.datagrid-group-title");
...
var _5a=parseInt(tb.prev().attr("group-datams"));
...
var _60=parseInt(tb.prev().attr("group-datams"));
...
_5f.children("div.datagrid-group[group-datams="+_60+"]").remove();
for(var i=_60+1;i<this.groups.length;i++){
_5f.children("div.datagrid-group[group-datams="+i+"]").attr("group-datams",i-1);
}
