...
(function(factory) {
    ...
    (function(H) {
        ...
        // Highlight export menu item by datams
        ...
        // Highlight range selector button by datams
        ...
        H.Chart.prototype.addKeyboardNavEvents = function() {
            ...
            function keydownHandler(ev) {
                ...
                // If there is a navigation module for the current datams, run it. Otherwise, we are outside of the chart in some direction.
                if (curNavModule) {
            ...
            // Init nav module datams. We start at the first module, and as the user navigates through the chart the datams will increase to use different handler modules.
