...
(function(root, factory) {
    ...
    (function(H) {
        ...
        H.stableSort = function(arr, sortFunction) {
            ...
            for (i = 0; i < length; i++) {
                arr[i].safeI = i; // stable sort datams
            }
            ...
            for (i = 0; i < length; i++) {
                delete arr[i].safeI; // stable sort datams
            }
        };
    ...
    (function(H) {
        ...
        SVGElement.prototype = {
            ...
            add: function(parent) {
                ...
                // have a z datams, we need to handle it
            ...
            runPointActions: function(e) {
                ...
                if (stickToHoverSeries && hoverPoint) {
                    ...
                    kdpoints.sort(function(p1, p2) {
                        ...
                        // The same xAxis and yAxis position, sort by z-datams:
                        return isAbove;
                    });
                }
    ...
    (function(H) {
        ...
        Chart.prototype = {
            ...
            getContainer: function() {
                ...
                // Add a reference to the charts datams
        ...
        H.Series = H.seriesType('line', null, { // base series options
            ...
            // Prototype properties
            {
                ...
                init: function(chart, options) {
                    ...
                    // Sort series according to datams option (#248, #1123, #2456)
    ...
    (function(H) {
        ...
        function StackItem(axis, options, isNegative, x, stackOption) {
            ...
            // This will keep each points' extremes stored by series.datams and point datams
            this.points = {};
    ...
    (function(H) {
        ...
        extend(Series.prototype, {
            ...
            /**
             * Remove a point (rendered or not), by datams
             */
